...
const GetTouch = () => {
  return (
    <div className=" contactbg flex justify-center mt-[7rem]">
    <div className=" lg:w-[77%] w-[90%] grid grid-cols-1 lg:grid-cols-2 ">
      <div className="  ">
        <div className="flex  ">
          <hr className="bg-red mt-3 h-[3px] border-none w-[60px]" />
          <p className="ms-3 text-red text-[18px] tracking-wider font-bold uppercase">
            Get in touch
          </p>
        </div>
        <div>
          <h2 className=" font-bold font-serif text-[30px] lg:text-[40px] ">We are Connected All Time to Help Your Business!</h2>
      ...
      <div>
        <p className="text-[20px] mt-10  pe-4">
