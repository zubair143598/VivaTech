    ...
    <div className=" lg:w-[80%] lg:ps-0 ps-3 mx-auto mt-[9rem]">
      <div className=" grid grid-cols-1 md:grid-cols-2">
        <div>
          ...
          <h1 className="text-[34px] xl:text-[40px] font-bold font-serif">
            We help to get Solutions!
          </h1>
          <div className="lg:me-16 space-y-7">
            <p className=" text-[18px] text-[#6EC1E4] ">
          ...
          <div className=" flex md:flex-row flex-col lg:space-y-0 mb-5 lg:mb-0 space-y-5  justify-center gap-x-10 me-16 mt-16">
        ...
        <div className=" px-4">
            <img className=" rounded-xl w-[90%] md:w-fit mx-auto " src="./assets/about_banner1.jpg" alt="" />
        </div>
      </div>
    </div>
  );
